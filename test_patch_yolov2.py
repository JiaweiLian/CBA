...
if __name__ == '__main__':
    ...
    ##################################################
    patchfile = "patches/upper_50_1024_yolov2_mean.png"
    savedir = "testing/yolov2_mean_upper_50_1024_yolov2"
    ##################################################
    ...
    for imgfile in os.listdir(imgdir):
        ...
        if imgfile.endswith('.jpg') or imgfile.endswith('.png'):
            ...
            # txtpath = os.path.abspath(os.path.join(savedir, 'clean/', 'labels-yolo/', txtname))
            ...
            boxes = do_detect(darknet_model, padded_img, 0.4, 0.45, True)
            # boxes = nms(boxes, 0.4)
