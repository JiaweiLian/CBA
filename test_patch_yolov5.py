...
if __name__ == '__main__':
    ...
    # 3080
    ######################################################################
    weights_yolov5 = "/home/ljw/yolov5/runs/train/yolov5x/weights/best.pt"
    ######################################################################
    ...
    ######################################################
    # 需修改
    patchfile = "patches/upper_50_1024_yolov5x_mean.png"
    savedir = "testing/yolov5x_mean_upper_50_1024_yolov5x"
    ######################################################

    model = DetectMultiBackend(weights_yolov5,
                               device=device,
                               dnn=False,
                               data=data).eval().cuda()  # Define a model
