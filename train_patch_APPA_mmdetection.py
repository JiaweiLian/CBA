...
class PatchTrainer(object):
    ...
    def train(self):
        ...
        alpha = 2.5  # default_value = 2.5
        beta = 0.01  # default_value = 0.01
        wandb.log({
            "alpha": alpha,
            "beta": beta,
            "Detector": self.mode,
            "Patch generation": "APPA_on",
        ...
        for epoch in range(n_epochs):
            ...
            if True:
                ...
                # del img_batch, lab_batch, adv_patch, adv_batch_t, p_img_batch_cpu, data, output, mean_prob, nps, tv, det_loss, p_img_batch, nps_loss, tv_loss, loss  # mean_prob
...
# CUDA_VISIBLE_DEVICES=0 python train_patch_APPA_mmdetection.py
